...
sys.path.append(os.path.dirname(os.path.join(os.path.dirname(os.path.abspath(__file__)), os.pardir, os.pardir)))
...
SECRET_KEY = 'w2ika4d$15y0)&gq$%ian984fm93^t7s363!ct-p1ern#0v(^o'
